...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        const { user } = this.state;
        if (user.firstName && user.middleName && user.lastName && user.birthDay && user.address && user.zip && user.city && user.city && user.username && user.password) {
        ...
        return (
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.middleName ? ' has-error' : '')}>
                        <label htmlFor="middleName">Middle Name</label>
                        <input type="text" className="form-control" name="middleName" value={user.middleName} onChange={this.handleChange} />
                        {submitted && !user.middleName &&
